...
FORMS_FIELDS = {
    "Entrer un nouveau joueur": (
        ...
        "Classement:"),
    "Entrer un nouveau tournoi": (
        # le nom doit commencer par tournoi. NB: faire ajout auto ?
        "Nom: ",
        "Lieu:",
        "Date de début (**/**/****):",
        "Date de fin (**/**/****):",
...
class PrepTournamentView(View):
    def __init__(self, name="Préparation du tournoi"):
        super().__init__(name)
...
class TournamentView(View):
    def __init__(self, name="Lancement du tournoi"):
        super().__init__(name)
